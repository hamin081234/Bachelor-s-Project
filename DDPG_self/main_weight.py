...
if prioritized:
    file_name = "testing_Priority_DDPG_"+env_name[:-12]+"_"+str(buffer_size)+"_"+str(seed)
else:
    file_name = "DDPG_"+env_name[:-12]+"_"+str(buffer_size)+"_"+str(seed)
...
if prioritized:
    file_name = "testing_Priority_DDPG_"+env_name[:-12]+"_"+str(buffer_size)+"_Transfer"+"_"+str(seed)
else:
    file_name = "DDPG_"+env_name[:-12]+"_"+str(buffer_size)+"_"+str(seed)
...
s_dim = env.observation_space.shape[0]
a_dim = env.action_space.shape[0]
print("Action_Walker: " + str(a_dim))
a_max = float(env.action_space.high[0])

policy.modify_policy(s_dim, a_dim, a_max, case)
